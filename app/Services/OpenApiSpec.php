    ...
    protected function components(): array
    {
        return [
            ...
            'schemas' => [
                ...
                'BookingCalculateRequest' => $this->bookingRequest(['tariff_id', 'asset_ids', 'start_time']),
                'BookingCreateRequest' => $this->bookingRequest(['tariff_id', 'asset_ids', 'start_time', 'status']),
                ...
                'SessionAsset' => $this->object([
                    ...
                    'room_number' => ['type' => 'string', 'nullable' => true, 'example' => '101'],
                ...
                'ServiceCreateRequest' => $this->object([
                    ...
                    'room_id' => ['type' => 'integer', 'example' => 101],
                    'cost' => ['type' => 'number', 'example' => 15000],
                ], ['game_name', 'room_id', 'cost']),
